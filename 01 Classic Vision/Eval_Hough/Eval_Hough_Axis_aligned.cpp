...
int main()
{
	std::string test_name = "canny_val_med5_mask_zoomed_nonAA";
	...
	std::vector<int> canny_lows = { 15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60};//
	std::vector<int> canny_hysts = { 30,33,36,39,42,45,48,51,54,57,60,63,66,69,72,75,78,81,84,87,90,93,96,99,102,105,108,111,114,117,120,123,126,129,132,135,138,141,144,147,150,153,156,159,162,165};//
