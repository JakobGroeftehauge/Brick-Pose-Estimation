...
int main()
{
  ...
  // roi simple
   ...
   cv::imshow(file_name + "_hough_axis_aligned", img_axis_aligned);
   cv::imshow(file_name + "_hough_no_axis_aligned", img_axis_non_aligned);

   imwrite(file_name + "_hough_axis_aligned.png", img_axis_aligned);
   imwrite(file_name + "_hough_no_axis_aligned.png", img_axis_non_aligned);
