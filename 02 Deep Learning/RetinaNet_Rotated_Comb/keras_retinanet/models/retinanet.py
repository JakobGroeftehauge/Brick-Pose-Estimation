...
def rotated_rect_submodels(num_classes, num_anchors):
    """ Create a list of default submodels used for object detection.
    ...
    """
    return [
        ('bbox_regression', default_regression_model(6, num_anchors)),
        ('classification', default_classification_model(num_classes, num_anchors))
    ]
...
def retinanet(
    ...
    if submodels is None:
        ...
        submodels = rotated_rect_submodels(num_classes, num_anchors)
